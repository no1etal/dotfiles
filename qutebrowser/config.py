...
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, 'file:///home/kopachke/.config/local/share/qutebrowser/userscripts/*')

# Allow locally loaded documents to access other local URLs.
# Type: Bool
config.set('content.local_content_can_access_file_urls', False, 'file:///home/kopachke/.config/local/share/qutebrowser/userscripts/*')

# Enable plugins in Web pages.
# Type: Bool
config.set('content.plugins', True, 'https://start.duckduckgo.com/')
